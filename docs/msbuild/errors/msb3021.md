...
To resolved this issue, there is a solution you can try. Check your output Directory location. there is a possibility that your output directory location does not match your current build location. This happens if you have move your solution or project from one location to naother.
